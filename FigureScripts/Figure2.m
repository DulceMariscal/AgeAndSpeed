...
%Ext of adaptation
% b3=subplot(3,6,extp);
% barGroups(studyData2,results,groups,params{i},epochs(3),1,[],[],b3)
...
% set(b(3),'YLim',[-0.1 0.13],'YTick',[-0.1 -0.05 0 0.05 0.1],'FontName','Arial','FontSize',12) %Temporal

% set(b2(1),'YLim',[-0.2 0.065],'YTick',[-0.2 -0.1 0 0.05 ],'FontName','Arial','FontSize',12) %SLA
% set(b2(2),'YLim',[0 0.21],'YTick',[0 0.05 0.1 0.15 0.2],'FontName','Arial','FontSize',12) %Spatial
% set(b2(3),'YLim',[0 0.22],'YTick',[0 0.05 0.10 0.15 0.2],'FontName','Arial','FontSize',12) %Temporal

% set(b3,'YLim',[0 0.32],'YTick',[0 0.05 0.10 0.15 0.2 0.25 0.3],'FontName','Arial','FontSize',12) %Temporal
...
% 
% ah1=findobj(b3,'Type','Bar');
% set(ah1(4),'FaceColor','w','EdgeColor', colorYoung,'LineWidth',2);
% set(ah1(3),'FaceColor', colorYoung,'EdgeColor','k');
% set(ah1(2),'FaceColor','w','EdgeColor',colorOld,'LineWidth',2);
% set(ah1(1),'FaceColor',colorOld,'EdgeColor','k');
% ah1=findobj(b3,'Type','Line');
% set(ah1(1:32),'MarkerFaceColor','w','MarkerEdgeColor','k','LineWidth',2);

set(gcf,'renderer','painters')
if savefig==1
saveas(gcf,'Figure_2_AdaptationByTrials','pdf')
end
