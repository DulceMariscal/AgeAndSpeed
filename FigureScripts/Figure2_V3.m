...
set(p(1),'YLim',[-0.25 0.1],'YTick',[-0.25 -0.15 -0.05 0 0.05 0.10],'FontName','Arial','FontSize',12) %SLA
set(p(2),'YLim',[-0.05 0.1],'YTick',[-0.1 -0.05 0 0.05 0.1 0.15],'FontName','Arial','FontSize',12) %Alpha
set(p(3),'YLim',[-0.25 0.05],'YTick',[-0.25 -0.2 -0.15 -0.1 -0.05 0 0.05 0.1 0.15 ],'FontName','Arial','FontSize',12) %Temporal
...
set(b(2),'YLim',[0 0.12],'YTick',[0 0.06 0.12],'FontName','Arial','FontSize',12) %Alpha
set(b(3),'YLim',[-.2 0],'YTick',[-0.2 -0.15 -0.1 -0.05 0],'FontName','Arial','FontSize',12) %Temporal
...
for i=1:length(params)
    ...
    set(ah1(4:6),'MarkerFaceColor',colorOld,'MarkerEdgeColor','k','LineWidth',.5,'MarkerSize',markersize);
    set(ah1(1:3),'MarkerFaceColor','w','MarkerEdgeColor',p_red,'LineWidth',.5,'MarkerSize',markersize);
    set(ah1(10:12),'MarkerFaceColor',  colorYoung,'MarkerEdgeColor','k','LineWidth',.5,'MarkerSize',markersize);
    set(ah1(7:9),'MarkerFaceColor','w','MarkerEdgeColor', blue,'LineWidth',.5,'MarkerSize',markersize);
    
    ah11=findobj(p(i),'Type','Patch');
    set(ah11(4:6),'FaceColor',colorOld,'EdgeColor',colorOld,'FaceAlpha',.4);
    set(ah11(1:3),'FaceColor','w','EdgeColor',p_red,'FaceAlpha',.3);
    set(ah11(10:12),'FaceColor', colorYoung,'EdgeColor', colorYoung,'FaceAlpha',.4);
    set(ah11(7:9),'FaceColor','w','EdgeColor', blue,'FaceAlpha',.3);
...
if savefig==1
saveas(gcf,'Figure_2_Adaptation_Only','pdf')
end
