...
% set(p(3),'YLim',[-0.03 0.09],'YTick',[-0.02 0 0.02 0.04 0.06 0.08],'FontName','Arial','FontSize',12) %Temporal
...
ylabel(p(1),'Sa','FontSize',16,'FontWeight','bold','FontName','Arial')
...
for i=1:length(params)
    ...
    set(ah1(1:4),'MarkerFaceColor',colorOld,'MarkerEdgeColor','k','LineWidth',LineWidth,'MarkerSize',markersize);
    set(ah1(5:8),'MarkerFaceColor','w','MarkerEdgeColor',colorOld,'LineWidth',LineWidth,'MarkerSize',markersize);
    set(ah1(9:12),'MarkerFaceColor',  colorYoung,'MarkerEdgeColor','k','LineWidth',LineWidth,'MarkerSize',markersize);
    set(ah1(13:16),'MarkerFaceColor','w','MarkerEdgeColor', colorYoung,'LineWidth',LineWidth,'MarkerSize',markersize);
    
    ah11=findobj(p(i),'Type','Patch');
    set(ah11(1:4),'FaceColor',colorOld,'EdgeColor',colorOld,'FaceAlpha',FaceAlpha);
    set(ah11(5:8),'FaceColor','w','EdgeColor',colorOld,'FaceAlpha',FaceAlpha2);
    set(ah11(9:12),'FaceColor', colorYoung,'EdgeColor', colorYoung,'FaceAlpha',FaceAlpha);
    set(ah11(13:16),'FaceColor','w','EdgeColor', colorYoung,'FaceAlpha',FaceAlpha2);
...
if savefig==1
saveas(gcf,'Figure_3_AfterEffects','pdf')
end
